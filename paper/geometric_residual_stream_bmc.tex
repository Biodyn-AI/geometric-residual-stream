...
Label-permutation analysis ($n = 40$) yielded an empirical $p$-value of 0.025 at layer~5, indicating that fewer than 1 in 40 random label assignments produced a $\DAURC$ as large as the observed value.
