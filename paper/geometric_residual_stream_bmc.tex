...
$\DAURC$ for the centered-cosine multi-layer bundle applied identically to scGPT and to Geneformer residual-stream activations.}
\label{tab:crossmatched}
\small
\begin{tabular}{lccc}
\toprule
\textbf{Domain} & \textbf{scGPT} & \textbf{Geneformer} & \textbf{Gap (GF$-$scGPT)} \\
\midrule
